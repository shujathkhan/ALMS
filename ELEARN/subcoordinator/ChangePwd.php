...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<br>
	<form class="form-horizontal" name="ChangePwd" onsubmit="return validateForm()">
	...
	<div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control" id="sID" placeholder="Enter Staff ID" required>
      </div>
    </div>
    ...
    <div class="form-group"> 
      ...
      <div class="col-sm-6">
        <input type="password" class="form-control" id="pwd" placeholder="Enter Current password" min="8" max="15" required>
      </div>
    </div>
	...
	<div class="form-group"> 
      ...
      <div class="col-sm-6">
        <input type="password" class="form-control" id="Npwd" placeholder="Enter New password" min="8" max="15" required>
      </div>
    </div>
	...
	<div class="form-group"> 
      ...
      <div class="col-sm-6">
        <input type="password" class="form-control" id="Rpwd" placeholder="Enter password again" min="8" max="15" required>
      </div>
    </div>
