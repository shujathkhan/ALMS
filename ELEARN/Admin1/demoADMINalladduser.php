...
$sql2=sprintf("INSERT INTO overallfaculty (firstname,lastname,staffid,emailid,username,password,role,groupname,status) VALUES ('$firstname','$lastname','$checkid','$email','$username','$password','$role','$groupname','$status') ;");
