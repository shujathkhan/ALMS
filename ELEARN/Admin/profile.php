      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="Courses.php"><i class="fa fa-upload"></i> Courses</a></li>
...
<?php
$id=$_SESSION['id'];
$sq=sprintf("SELECT firstname,lastname,emailid,contactno FROM overallfaculty WHERE id='$id' ");
$res34=mysqli_query($conn,$sq);
if($res34){
	while($row=mysqli_fetch_row($res34)){
		
?>
		<form class="form-horizontal"  method="POST" action="profileform.php" onsubmit="return validateForm()">
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-4">
			<input type="text" class="form-control" value="<?php echo $row[0]?>" id="fname" name="fname" placeholder="Enter First Name" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-4">
			<input type="text" class="form-control" value="<?php echo $row[1]?>" id="lname" name="lname" placeholder="Enter Last Name" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-4">
			<input type="text" class="form-control" value="<?php echo $_SESSION['id']?>" id="sID" name="sID" placeholder="Enter Staff ID" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-4">
			<input type="email" class="form-control" value="<?php echo $row[2]?>" id="email" name="email" placeholder="Enter Email ID" required>
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-4" for="email">Contact Number:</label>
		  <div class="col-sm-4">
			<input type="number" class="form-control" value="<?php echo $row[3]?>" id="contactno" name="contactno" placeholder="Enter Contact No," required>
		  </div>
		</div>
