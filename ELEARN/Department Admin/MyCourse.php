...
$select.='<td><input type="button" class="btn btn-warning" data-toggle="modal" data-target="#efmodal'.$count.'"  value="Enroll Students">
</td>';
$select.='<td><input type="button" class="btn btn-blue" data-toggle="modal" data-target="#myModal2'.$count.'"  value="View Corona">
</td>';
$select.='</tr>';
...
$query1 = sprintf("SELECT firstname, studentid FROM overallstudent");
$result1 =mysqli_query($conn,$query1); 
$select.='<div class="form-group"><label class="control-label col-sm-4" for="department">Select Student:</label><div class="col-sm-5"><select  class="form-control" id="choice"  name="faculty">';
...
$select.='<br><div class="form-group"><label class="control-label col-sm-4" for="department">                       </label><div class="col-sm-5"><button type="submit" name="enroll" class="btn btn-default" data-dismiss="efmodal">Enroll</button></div></div>
	  ...
	  $select.='<div id="myModal2" class="modal fade" role="dialog">
