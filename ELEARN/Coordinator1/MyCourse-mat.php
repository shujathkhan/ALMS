...
$select.='<td><button class="waves-effect waves-light btn orange darken-1 modal-trigger" href="#efmodal'.$count.'">Enroll faculty</button>
</form>
</td>';
$select.='</tr>';
...
$select1='<div class="container"><div class="container"><canvas id="rgraph_canvas" height="800" width="800"></canvas></div></div>
...
$("#coursecircle").addClass('hidden');
	...
	document.getElementById("enrollcourse").innerHTML = '<div class="input-field col s4"><input type="text" id="facultynum"></div><span class="col s4 offset-s4"><a id="selected" class="waves-effect waves-light btn blue" value="Select Faculty" onclick="generate()"></span>'
	}
	</script>
    ...
    function generate() {
        ...
        for (i = 0; i < a; i++) {
			...
			toAppend = "<br><center><div class='row' ><div class='input-field col s5'>. <select class='browser-default"	 id='selectfaculty'><option>Select Faculty</option></select></div></center><br>"; 
