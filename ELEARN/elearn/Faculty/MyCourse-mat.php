...
$select.='<td><input type="button" class="waves-effect waves-light btn red accent-4" data-toggle="modal" data-target="#efmodal'.$count.'"  value="Enroll Student">
</form>
</td>';
$select.='</tr>';
...
if(!is_null($wesd)){
$select.='<div class="row"><div class="input-field col s5"><select  class="form-control" id="studentid"  name="studentid">';
