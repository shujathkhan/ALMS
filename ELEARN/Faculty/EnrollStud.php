  ...
  <aside class="main-sidebar">
	...
	<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="MyCourse.php"><i class="fa fa-tasks"></i> My Courses</a></li>
            <li><a href="EnrollStud.php"><i class="fa fa-tasks"></i> Student Enrollment</a></li>
...
<ul class="nav nav-tabs ">
    <li class="active"><a data-toggle="tab" href="#home">Individual Enrollment</a></li>
    <li><a data-toggle="tab" href="#menu1">Bulk Enrollment</a></li>
    ...
    <section class="content">
		...
		<div class="form-group">
		<label class="control-label col-sm-4" for="select">Course ID:</label>
		<div class="col-sm-4">
		<select class="form-control" id="select" name="courseid">
		...
		<div class="form-group"> 
		  <label class="control-label col-sm-4" for="stud">Student ID:</label>
		  <div class="col-sm-4">
			<input type="search" class="form-control" id="stud" name="studentid" placeholder="Enter Student ID" required>
		  </div>
		</div>
