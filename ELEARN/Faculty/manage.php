...
echo '
<table cellspacing=5 cellpadding=5  id="dataTable" class="table table-hover">
	<thead>
<th></th>	    
        <th>Department</th>
        <th>First name</th>
		...
		<th>Username</th>
		<th>Password</th>
		<th><input type="submit" id="savndel" name="save"  value="Save"  class="btn waves-effect waves-light lime green accent-4" ></th>
		<th><input type="submit" id="savndel" name="delete" value="Delete"  class="btn waves-effect waves-light red" ></th>
      </thead>';
