...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      	...
      	<form class="form-horizontal" action="demofacultyenrollstudent.php" method="POST">
	<br>
	<br>
...
if( !$result ){
$message="no courses found ,register first ";
}
else{
...
$asd=sprintf("SELECT courseid,coursename,coursetype from course WHERE courseid='it1017' ")	;
...
while( $rower = mysqli_fetch_array($res) )  {
$count=$count+1;
//echo 'qwaszx';
$select.='<tr id="row'.$count.'" display="none">';
$select.='<td>'.$rower[0].'</td>';
$select.='<td id="name_row1">'.$rower[1].'</td>';
$select.='<td id="name_row1">'.$rower[2].'</td>';
$select.='<td id="name_row1"><input type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal2" value="Enroll Students"></td>';
$select.='</tr>';
}
echo $select;
}else{
	$message="no courses registered to,try again";
