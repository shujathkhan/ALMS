...
<th><input type="checkbox" name="checkbox[]" id="checkAll" ><label for="checkAll"></label></th>	    
		...
		<th>Username</th>
		<th>Password</th>
		<th><input type="submit" id="savndel" name="save"  value="Save"  class="waves-effect waves-light btn lime green accent-3" ></th>
		<th><input type="submit" id="savndel" name="delete" value="Delete"  class="waves-effect waves-light btn red"  ></th>
      </thead><tbody>';
...
$select.='<td><input type="checkbox" onclick="selectRow(this)"  name="checkbox[]" id="checkbox'.$row[2].'[]" value="'.$row[2].'" ><label for="checkbox'.$row[2].'[]"></label></td>';
$select.='<td id="name_row1" class="input-field"><input type="text" name="dept[]" value="'.$depart.'" readonly></td>
