...
$select.='<tr id="row1">';
$select.='<td><input type="checkbox" class="all" onclick="selectRow(this)" id="checkbox'.$row[0].'[]" name="checkbox[]" value="'.$row[0].'"><label for="checkbox'.$row[0].'[]"></label ></td>';
$select.='<td id="name_row1"><input type="hidden" value="'.$row[3].'" name="dept[]">'.$row[3].'</td><td>'.$row[0].'</td><td>'.$row[1].'</td><td>'.$row[2].'</td>';
$select.='<td><select class="browser-default" name="id[]">';
