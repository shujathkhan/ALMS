...
<ul class="nav nav-tabs ">
    ...
    <section class="content">
		...
		<option value="coordinator">Sub-Coordinator</option>
	  ...
	  <div id="menu1" class="tab-pane fade">
	   <section>
		...
		<div class="col-sm-4">
		<select class="form-control" id="department" name="role" required>
		<option>Select Role</option>
		
		<option value="Department Admin">Department Admin</option>
		<option value="Coordinator">Course Coordinator</option>
		<option value="Sub-coordinator">Course Sub-coordinator</option>
		<option value="Faculty">Faculty</option>
		<option value="Student">Student</option>
		</select>
		</div>
