  ...
  <div class="content-wrapper" style="background-color:white;">
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			 ...
			 <button class="btn btn-default dropdown-toggle" id="activity" name="activity" type="button" data-toggle="dropdown">Select Role
			<span class="caret"></span></button>
			<ul class="dropdown-menu">
				<li><a tabindex="-1">Admin</a><li>
	...
	<div class="form-group">
		<div class="col-sm-2">
			 ...
			 <button class="btn btn-default dropdown-toggle" id="activity" name="activity" type="button" data-toggle="dropdown">Option
			<span class="caret"></span></button>
			<ul class="dropdown-menu">
				<li><a tabindex="-1">Add</a><li>
	...
	<script text="javscript">
			...
			function myfaculty() {
				document.getElementById("facultified").innerHTML = '<select class="form-control" name="faculty" ><option>Choose Faculty</option></select>';
			}
			</script>
